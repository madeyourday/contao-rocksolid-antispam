...
class CaptchaReplacement extends \FormCaptcha
{
	...
	{
		if ($this->antispamField) {
			return '<div style="display: none !important">' . $this->antispamField->generateLabel() . '</div>';
		}
	...
	public function generateQuestion()
	{
		...
		return parent::generateQuestion();
	}
	...
	{
		if ($this->antispamField) {
			return '<div style="display: none !important">' . $this->antispamField->generate() . '</div>';
		}
